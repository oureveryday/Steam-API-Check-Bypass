        ...
        if (cfg) {
            ...
            case ntfsdupe::cfgs::FileType::original: {
                ...
                if (cfg->hook_times.mode == ntfsdupe::cfgs::HookTimesMode::nth_time_only && cfg->hook_times.hook_times != cfg->hook_times.hook_time_n) {
                    NTFSDUPE_DBG(L"ntfsdupe::hooks::NtOpenFile_hook original '%s', %d times, return original", cfg->original.c_str(), cfg->hook_times.hook_times);
                ...
                NTFSDUPE_DBG(L"ntfsdupe::hooks::NtOpenFile_hook original '%s', %d times", cfg->original.c_str(), cfg->hook_times.hook_times);
